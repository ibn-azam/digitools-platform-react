    ...
    return (
       <div>
        ...
        <div className='border-2 h-50 border-[#f2f2f2] p-10 rounded-2xl flex flex-col my-5 mx-10'>
             <h2 className='text-center font-bold text-[#101727] text-[24px]  mb-2 mt-4'>No Card Selected Yet</h2> 
             <p className='text-xl text-[#627382]'>Go To Products Tab To Purchase Products</p> 
             </div>
             : 
         <div className='border-2 border-[#f2f2f2] p-10 rounded-2xl flex flex-col my-5 mx-10'>
            ...
            <div className='flex justify-between my-3'>
                        ...
                        <h4 className='text-[20px] text-[#101727] font-medium'>{totalPrice ?? 0}</h4>
                    </div>
                    <button onClick={()=>handleProceedBtn()} className='btn bg-linear-to-r from-[#4f39f6] to-[#9514fa] text-white font-bold rounded-full '>Proceed To Checkout</button>
