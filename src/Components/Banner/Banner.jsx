...
const Banner = () => {
    return (
        <section>
            <div className='bg-linear-to-r from-[#4f39f6] to-[#9514fa]   md:flex md:px-50 md:py-10  justify-center items-center py-10  mb-[85px]'>
                <div className='text-center'>
                    <h2 className='text-[60px] font-bold text-white'>50k+</h2>
                    <p className='text-[#FFFFFF]'>Active Users</p>
                </div>
                <hr className='border rotate mt-5 mx-auto md:rotate-90 w-12 border-amber-50'/>
                <div className='text-center'>
